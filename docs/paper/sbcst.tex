...
\input{response_rows.tex}
\input{semantic_rows.tex}
...
\author{Tom Xu\\\small Independent Research\\\small\href{https://github.com/tomTom1010-IEE/KK_Modder-BatchTool}{KK Modder BatchTool}}
\date{\small Technical manuscript \;\textbullet\; September 2026}
\hypersetup{pdftitle={Semantic Budget-Constrained Skinning Transfer for Garment Retargeting},pdfauthor={Tom Xu},pdfsubject={Semantic influence conservation and constrained garment skinning transfer},pdfkeywords={skinning, garment retargeting, semantic budgets, quadratic programming}}
\begin{document}
\raggedbottom
\maketitle
...
\caption{SBCST separates invariant influence allocation from task-dependent fitting. The upper branch preserves authored response under new body proportions. The lower branch addresses footwear whose fitted extent makes target-body spatial association a more useful objective. Both branches retain clothing dynamics and use independent validation before writeback.}
\label{fig:pipeline}
\end{figure*}
...
\begin{figure*}[t]
\centering\includegraphics[width=\textwidth]{figures/semantic.pdf}
...
\begin{figure*}[t]
\centering\includegraphics[width=\textwidth]{figures/response.pdf}
...
\bibitem{artifact} Tom Xu. 2026. KK Modder BatchTool: SBCST implementation and measurement artifacts. \url{https://github.com/tomTom1010-IEE/KK_Modder-BatchTool}. Measurement snapshot: September 21, 2026.
\end{thebibliography}
\end{document}
